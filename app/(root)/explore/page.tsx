    ...
    <>
      ...
      <div className="relative">
        <Input
          ...
          className="mt-2 w-[98%] mx-auto block border-none bg-custom-green text-white"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 mt-6">
            {users.map((user) => (
              <Link key={user._id} href={`/profile/${user._id}`}>
                <div className="border-b-[1px] border-neutral-800 p-5 cursor-pointer hover:bg-custom-green transition relative mr-4">
